...
public class Ex31 {
     ...
     public static void main(String args[]) {
    	byte acao = 0;
    	ContaEspecial cliente = new ContaEspecial();
    	...
    	do{
	    	...
	    	switch(acao){
	    		case 1: 
	    	 	...
	    	 	case 2:
	    	 		if(cliente.VerificarSenha()){
	    	 			if(!cliente.retirar(Float.parseFloat(JOptionPane.showInputDialog(null, "Informe o valor a ser retirado: ")))){
    			...
    			case 5:
    				if(cliente.VerificarSenha()){
    					JOptionPane.showMessageDialog(null, "O limite da sua conta e: " + cliente.exibirLimite());
    				} else {
    					JOptionPane.showMessageDialog(null, "Senha incorreta...");
    				}
